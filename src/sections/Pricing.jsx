    ...
    <section>
      <Element name="pricing">
        <div className="container">
          ...
          {/* prcing section */}
          <div className="scroll-hide relative z-2 -mt-12 flex items-start justify-center max-xl:justify-start max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, index) => (
              <div
                ...
                <div
                  className={clsx(
                    "body-1 relative z-2 mb-10 w-full border-b-s2 text-center text-p4 pb-6",
                    index === 1 && "border-b"
                  )}>
                  {plan.caption}
                </div>
